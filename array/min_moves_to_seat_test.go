...
func TestMinMovesToSeat(t *testing.T) {
	...
	the ith seat. You are also given the array students of length n, 
	...
	t.Run("Suite 1", func(t *testing.T) {
		...
		students := []int{2, 7, 4}
		exp := 4
		assert.Equal(t, exp, RunMinMovesToSeat(seats, students))
	})
...
func RunMinMovesToSeat(seats []int, students []int) int {
	sort.Ints(seats)
	sort.Ints(students)
